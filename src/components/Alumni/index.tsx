...
export default function Alumni() {
    ...
    return (
        <div className="container flex flex-col w-full lg:flex-row">
            <div className="grid flex-grow sm:h-screen card place-items-center">
            ...
            <div className="grid flex-grow card bg-base-300 rounded-box place-items-center">
                <div className="sm:h-screen carousel px-2 gap-2 sm:carousel-vertical rounded-box place-items-center">
