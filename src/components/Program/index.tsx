...
export default function Program() {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full py-10">
            ...
            <article className="container prose py-10 text-center">
                <h1>Kalender Akademik LC 2024</h1>
            </article>
            <Image alt="kalender akademik 2024" src={kalender} className="container md:w-1/4" />
        </div>
    )
}
